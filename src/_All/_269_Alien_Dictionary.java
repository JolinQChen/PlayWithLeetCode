...
public class _269_Alien_Dictionary {
    public String alienOrder_1(String[] words) {
        ...
        for(int i=1; i < n; i++) {
            ...
            //in the below condition prev.startsWith(curr) takes care of situations like prev=abcd and curr = ab - this is invalid as specified in one of the _All.solution
